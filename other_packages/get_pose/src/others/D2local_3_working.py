...
param = dict( vel=0.1, psi_vel=0.5, kp=2, kd=10, kppsi=-0.5, lim=1, limpsi=1, nv=10)
# param = dict( vel=0.1, psi_vel=0.5, kp=2, kd=10, kppsi=1, lim=1, limpsi=1, nv=10)

tv = coll.deque([1e-5, 2e-5], maxlen=param['nv'])
xv = coll.deque([1e-5, 2e-5], maxlen=param['nv'])
yv = coll.deque([1e-5, 2e-5], maxlen=param['nv'])
psiv = coll.deque([1e-5, 2e-5], maxlen=param['nv'])
